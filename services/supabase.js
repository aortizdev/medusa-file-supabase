  ...
  (0, _createClass2["default"])(SupabaseService, [{
    ...
    value: function () {
      var _upload = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(file) {
        var opts, parsedFilename, filePath, _yield$this$storageCl, data, error;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return this.storageClient().from(this.bucket_name).upload(filePath, (0, _fs.createReadStream)(file.path), opts);
              case 6:
